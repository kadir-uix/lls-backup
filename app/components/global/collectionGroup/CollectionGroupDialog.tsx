  ...
  return (
    <div className="relative flex items-center">
      ...
      <>
        <button
          className={clsx(
            '-sm -mx-3 flex h-[2.4rem] items-center bg-darkGray bg-opacity-0 py-2 pl-2 pr-3 text-sm duration-150',
            'hover:bg-opacity-10',
          )}
          onClick={handleOpen}
        >
      ...
      <Transition show={isOpen} unmount={false}>
        ...
        >
          ...
          >
            <Dialog.Panel
              className={`-r-lg fixed bottom-0 left-0 right-0 top-0 flex h-full w-full flex-col overflow-y-auto bg-white md:bottom-auto md:right-auto md:block md:w-[490px]`}
            >
