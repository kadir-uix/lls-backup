        ...
        {({open}: {open: boolean}) => {
          ...
          return (
            <div className="relative inline-flex">
              <Listbox.Button
                className={clsx(
                  '-sm flex h-[2.4rem] items-center bg-darkGray bg-opacity-0 px-3 py-2 text-sm font-bold duration-150',
                  'hover:bg-opacity-10',
                )}
              >
                <span className="mr-2">
              ...
              <Listbox.Options
                className={clsx(
                  'absolute top-full z-10 mt-3 min-w-[150px] overflow-hidden  shadow',
