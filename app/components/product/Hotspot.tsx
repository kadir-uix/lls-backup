...
export default function ProductHotspot({productGid, variantGid, x, y}: Props) {
  ...
  return (
    ...
    >
      <Link
        className={clsx(
          '-full absolute left-[50%] top-[50%] flex h-[26px] w-[26px] -translate-x-1/2 -translate-y-1/2 animate-pulse items-center justify-center bg-offBlack duration-300 ease-out',
      ...
      >
        <div className="-full relative h-[4px] w-[4px] bg-white" />
      </Link>
    </Tippy>
  );
}
